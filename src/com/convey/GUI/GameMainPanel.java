 ...
 * @author jgonzalez
 */
public class GameMainPanel extends javax.swing.JPanel {
    ...
    public void checkResponse(String response){
        if(this.currentCuestion.evalResponse(response)){
            this.lblMensajeRespuesta.setText("Respuesta Correcta!!!");
        }else{
            this.lblMensajeRespuesta.setText("Respuesta Incorrecta!!!");
        }
