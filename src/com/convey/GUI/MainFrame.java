...
public class MainFrame extends javax.swing.JFrame {
        ...
        arduinoDevice.addArduinoEventListener(new ArduinoEventAdapter() {
            ...
            public void onMessageReceived(String p_message) {
                ...
                switch (l_components[0]) {
                    ...
                    case "0":
                        javax.swing.JOptionPane.showMessageDialog(null, l_components[1]);
                        break;
    ...
    private void initComponents() {
        ...
        javax.swing.KeyStroke escapeKeyStroke = javax.swing.KeyStroke.getKeyStroke("ESCAPE");
        ...
        this.getRootPane().getInputMap(javax.swing.JComponent.WHEN_IN_FOCUSED_WINDOW).put(escapeKeyStroke, "ESCAPE");
    ...
    private void arduinoSettingsItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_arduinoSettingsItemActionPerformed
        installNewPanel(new ArduinoPanel(this));
    ...
    private void dbConfigItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dbConfigItemActionPerformed
        installNewPanel(new DataBasePanel(this));
    ...
    private void loadQuestionsItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadQuestionsItemActionPerformed
        ...
        javax.swing.JFileChooser l_fileChooser = new javax.swing.JFileChooser();
        int returnVal = l_fileChooser.showOpenDialog(l_fileChooser);
        if (returnVal == javax.swing.JFileChooser.APPROVE_OPTION) {
            java.io.File file = l_fileChooser.getSelectedFile();
    ...
    public void installNewPanel(javax.swing.JComponent p_component) {
        if (getContentPane().getComponent(0) != null) {
